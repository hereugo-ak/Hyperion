    ...
    def _process_all_images(self) -> dict[str, str]:
        ...
        for i, img_path in enumerate(self._image_paths):
            try:
                ...
                # the fallback silently substitutes the unprocessed original and
                # nothing anywhere said which image, or by how much it missed.
                logger.warning(
                    "Section image rejected as too small, using unprocessed original: "
        ...
        for chart_path in self._chart_paths:
            try:
                ...
                # one means the export tier degraded (kaleido -> matplotlib ->
